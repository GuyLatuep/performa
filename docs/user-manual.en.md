...
Saved searches belong to the account they were written for — the fields and projects their JQL names mean nothing on another Jira — so signing in as somebody else starts with an empty list.
